...
class BidiStreamRequest {
    ...
    sendMessage(content = {}) {
      return new Promise((resolve, reject) => {
        ...
        if (this.stream.received_status) {
          return reject(new Error('stream_closed'))
        }
  ...
  const makeBidirectionalStreamRequest = function(client, originalFunction, options) {
    return function() {
      return new BidiStreamRequest(client, originalFunction, options)
    }
  }

  module.exports = makeBidirectionalStreamRequest
