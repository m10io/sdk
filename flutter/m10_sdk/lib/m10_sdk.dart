...
class M10Sdk {
  ...
  Future<List<AccountMetadataDoc>> findAccountByOwner({
    ...
    final request = ListAccountMetadataRequest();
  ...
  Future<int> updateAccount({
    ...
    dynamic builder = DocumentUpdate(AccountMetadata());
  ...
  Future<List<RoleDoc>> listRole({
    ...
    final request = ListRolesRequest();
    request.name = name;
  ...
  Future createRole({
    ...
    role.id = (id != null ? hex.decode(id) : uuid.v4buffer(List.filled(16, 0)));
    role.name = name;
    role.owner = ownerBytes ?? await signer.publicKey();
  ...
  Future updateRole({
    ...
    dynamic builder = DocumentUpdate(Role());
  ...
  Future<RoleBindingDoc> getRoleBinding({
    ...
    final request = GetRoleBindingRequest();
    request.id = hex.decode(id);
  ...
  Future createRoleBinding({
    ...
    roleBinding.id =
        (id != null ? hex.decode(id) : uuid.v4buffer(List.filled(16, 0)));
  ...
  Future<List<EnhancedTransferStepDoc>> enhance(TransferDoc transfer) async {
    return await enhanceTransferSteps(
  ...
  Future<List<EnhancedTransferStepDoc>> enhanceTransferSteps(
    ...
    return await Stream.fromIterable(steps)
  ...
  Future<String> createLedgerAccount({
    ...
    account.balanceLimit = Int64(balanceLimit ?? 0);
