...
const ListAccountMetadataRequest$json = const {
...
final $typed_data.Uint8List listAccountMetadataRequestDescriptor = $convert.base64Decode('ChpMaXN0QWNjb3VudE1ldGFkYXRhUmVxdWVzdBIWCgVvd25lchgBIAEoDEgAUgVvd25lchIUCgRuYW1lGAIgASgJSABSBG5hbWUSIQoEcGFnZRgEIAEoCzINLm0xMC5zZGsuUGFnZVIEcGFnZUIICgZmaWx0ZXI=');
@$core.Deprecated('Use listAccountMetadataResponseDescriptor instead')
const ListAccountMetadataResponse$json = const {
  '1': 'ListAccountMetadataResponse',
  '2': const [
    const {'1': 'accounts', '3': 1, '4': 3, '5': 11, '6': '.m10.sdk.model.AccountMetadata', '10': 'accounts'},
    const {'1': 'next_request', '3': 2, '4': 1, '5': 11, '6': '.m10.sdk.ListAccountMetadataRequest', '10': 'nextRequest'},
  ],
};

/// Descriptor for `ListAccountMetadataResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listAccountMetadataResponseDescriptor = $convert.base64Decode('ChtMaXN0QWNjb3VudE1ldGFkYXRhUmVzcG9uc2USOgoIYWNjb3VudHMYASADKAsyHi5tMTAuc2RrLm1vZGVsLkFjY291bnRNZXRhZGF0YVIIYWNjb3VudHMSRgoMbmV4dF9yZXF1ZXN0GAIgASgLMiMubTEwLnNkay5MaXN0QWNjb3VudE1ldGFkYXRhUmVxdWVzdFILbmV4dFJlcXVlc3Q=');
...
const ListBanksRequest$json = const {
  '1': 'ListBanksRequest',
  '2': const [
    const {'1': 'page', '3': 1, '4': 1, '5': 11, '6': '.m10.sdk.Page', '10': 'page'},
  ],
};

/// Descriptor for `ListBanksRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listBanksRequestDescriptor = $convert.base64Decode('ChBMaXN0QmFua3NSZXF1ZXN0EiEKBHBhZ2UYASABKAsyDS5tMTAuc2RrLlBhZ2VSBHBhZ2U=');
@$core.Deprecated('Use listBanksResponseDescriptor instead')
const ListBanksResponse$json = const {
  '1': 'ListBanksResponse',
  '2': const [
    const {'1': 'banks', '3': 1, '4': 3, '5': 11, '6': '.m10.sdk.model.Bank', '10': 'banks'},
  ],
};

/// Descriptor for `ListBanksResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listBanksResponseDescriptor = $convert.base64Decode('ChFMaXN0QmFua3NSZXNwb25zZRIpCgViYW5rcxgBIAMoCzITLm0xMC5zZGsubW9kZWwuQmFua1IFYmFua3M=');
@$core.Deprecated('Use getBankRequestDescriptor instead')
const GetBankRequest$json = const {
  '1': 'GetBankRequest',
  '2': const [
    const {'1': 'id', '3': 1, '4': 1, '5': 12, '10': 'id'},
  ],
...
final $typed_data.Uint8List getBankRequestDescriptor = $convert.base64Decode('Cg5HZXRCYW5rUmVxdWVzdBIOCgJpZBgBIAEoDFICaWQ=');
