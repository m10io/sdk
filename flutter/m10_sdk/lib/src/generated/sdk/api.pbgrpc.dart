...
class M10QueryServiceClient extends $grpc.Client {
  ...
  static final _$getAccountMetadata =
      $grpc.ClientMethod<$0.RequestEnvelope, $2.AccountMetadata>(
          '/m10.sdk.M10QueryService/GetAccountMetadata',
          ($0.RequestEnvelope value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $2.AccountMetadata.fromBuffer(value));
  ...
  static final _$listAccountMetadata =
      $grpc.ClientMethod<$0.RequestEnvelope, $0.ListAccountMetadataResponse>(
          '/m10.sdk.M10QueryService/ListAccountMetadata',
          ($0.RequestEnvelope value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.ListAccountMetadataResponse.fromBuffer(value));
  ...
  static final _$listBanks =
      $grpc.ClientMethod<$0.RequestEnvelope, $0.ListBanksResponse>(
          '/m10.sdk.M10QueryService/ListBanks',
          ($0.RequestEnvelope value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.ListBanksResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$2.AccountMetadata> getAccountMetadata(
      $0.RequestEnvelope request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.ListAccountMetadataResponse> listAccountMetadata(
      $0.RequestEnvelope request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.ListBanksResponse> listBanks(
      $0.RequestEnvelope request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$listBanks, request, options: options);
  }

  $grpc.ResponseFuture<$2.Bank> getBank($0.RequestEnvelope request,
      {$grpc.CallOptions? options}) {
...
abstract class M10QueryServiceBase extends $grpc.Service {
  ...
  M10QueryServiceBase() {
    ...
    $addMethod(
        $grpc.ServiceMethod<$0.RequestEnvelope, $0.ListAccountMetadataResponse>(
            'ListAccountMetadata',
  ...
  $async.Future<$2.AccountMetadata> getAccountMetadata_Pre(
      $grpc.ServiceCall call, $async.Future<$0.RequestEnvelope> request) async {
  ...
  $async.Future<$0.ListAccountMetadataResponse> listAccountMetadata_Pre(
      $grpc.ServiceCall call, $async.Future<$0.RequestEnvelope> request) async {
  ...
  $async.Future<$0.ListBanksResponse> listBanks_Pre(
      $grpc.ServiceCall call, $async.Future<$0.RequestEnvelope> request) async {
    return listBanks(call, await request);
  }

  $async.Future<$2.Bank> getBank_Pre(
      $grpc.ServiceCall call, $async.Future<$0.RequestEnvelope> request) async {
  ...
  $async.Future<$1.IndexedAccount> getIndexedAccount(
      $grpc.ServiceCall call, $0.RequestEnvelope request);
  $async.Future<$2.AccountMetadata> getAccountMetadata(
      $grpc.ServiceCall call, $0.RequestEnvelope request);
  $async.Future<$2.AccountInfo> getAccountInfo(
      $grpc.ServiceCall call, $0.RequestEnvelope request);
  $async.Future<$0.ListAccountMetadataResponse> listAccountMetadata(
      $grpc.ServiceCall call, $0.RequestEnvelope request);
  ...
  $async.Stream<$0.TransactionMetrics> observeMetrics(
      $grpc.ServiceCall call, $0.RequestEnvelope request);
  $async.Future<$0.ListBanksResponse> listBanks(
      $grpc.ServiceCall call, $0.RequestEnvelope request);
  $async.Future<$2.Bank> getBank(
      $grpc.ServiceCall call, $0.RequestEnvelope request);
}
